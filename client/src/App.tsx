...
function App() {
  ...
  return <div className="site">
    ...
    <main>
      ...
      <section id="reservas" className="reserve"><div className="container"><div className="reserve-head"><div><p className="section-kicker">RESERVAS</p><h2>Primero vienes a disfrutar.<br/><em>Después, vuelves a celebrar.</em></h2></div></div><div className="reserve-grid"><article className="reserve-card reserve-card-main"><span className="reserve-number">01</span><div><h3>Una mesa para disfrutar</h3><p>Ven con tu familia, pareja o amigos y asegura tu lugar para comer rico, respirar aire fresco y pasarla bien.</p><a className="btn btn-primary" href="https://wa.me/51946139670?text=Hola%20Sr%27%20Sifuentes%2C%20quiero%20reservar%20una%20mesa%20para%20visitar%20el%20restaurante." target="_blank" rel="noreferrer">Reservar mi mesa <ChevronRight size={17}/></a><small>946 139 670 · Respuesta rápida</small></div></article><article className="reserve-card reserve-card-event"><span className="reserve-number">02</span><div><span className="card-overline">EVENTOS SOCIALES Y CORPORATIVOS</span><h3>Un espacio para tu fecha</h3><p>Aniversarios, celebraciones familiares, Navidad, Año Nuevo o encuentros de empresa en un ambiente independiente.</p><a className="event-note" href="https://wa.me/51946139670?text=Hola%20Sr%27%20Carlos%2C%20quiero%20informaci%C3%B3n%20sobre%20un%20evento." target="_blank" rel="noreferrer">Consultar por un evento <ChevronRight size={15}/></a></div></article></div></div></section>
