...
function App() {
  ...
  return <div className="site">
    ...
    <main>
      ...
      <section id="reservas" className="reserve"><div className="container"><div className="reserve-head"><div><p className="section-kicker">RESERVAS</p><h2>Haz espacio para<br/><em>un buen día.</em></h2></div><p>Elige cómo quieres vivir D' Carlitos: una mesa para disfrutar o un espacio para celebrar.</p></div><div className="reserve-grid"><article className="reserve-card reserve-card-main"><span className="reserve-number">01</span><div><h3>Reservar una mesa</h3><p>Ven con tu familia, pareja o amigos y asegura tu lugar para disfrutar del restaurante.</p><a className="reserve-action reserve-action-primary" href="https://wa.me/51946139670?text=Hola%20Sr%27%20Sifuentes%2C%20quiero%20reservar%20una%20mesa%20para%20visitar%20el%20restaurante." target="_blank" rel="noreferrer">Reservar mi mesa <ChevronRight size={17}/></a></div></article><article className="reserve-card reserve-card-event"><span className="reserve-number">02</span><div><span className="card-overline">EVENTOS</span><h3>Consultar un evento</h3><p>Un espacio independiente para celebraciones familiares y encuentros corporativos.</p><a className="reserve-action reserve-action-secondary" href="https://wa.me/51946139670?text=Hola%20Sr%27%20Carlos%2C%20quiero%20informaci%C3%B3n%20sobre%20un%20evento." target="_blank" rel="noreferrer">Consultar disponibilidad <ChevronRight size={17}/></a></div></article></div></div></section>
